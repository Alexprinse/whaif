...
const ShadowTwinInputModal: React.FC<ShadowTwinInputModalProps> = ({ 
    ...
    switch (currentStep) {
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-violet-500 to-blue-500 flex items-center justify-center">
            ...
            <div>
              <input
                ...
                className="w-full p-4 bg-black/30 backdrop-blur-md border border-white/10 rounded-xl text-white placeholder-gray-400 focus:border-violet-400/50 focus:outline-none focus:ring-2 focus:ring-violet-400/20 transition-all duration-300 text-center text-lg"
              />
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">Tell us about your current life</h3>
              <p className="text-gray-400">Your background, career, relationships, and current situation</p>
            </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">What major life decisions did you make?</h3>
              <p className="text-gray-400">Career choices, relationships, education, financial decisions</p>
            </div>
      ...
      case 4:
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-pink-500 to-violet-500 flex items-center justify-center">
                <Sparkles className="text-white" size={24} />
              </div>
              <h3 className="text-2xl font-bold text-white mb-2">What dreams did you not pursue?</h3>
              <p className="text-gray-400">Creative pursuits, travel dreams, alternative careers</p>
            </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">Upload a photo (optional)</h3>
              <p className="text-gray-400">This helps create a more personalized simulation</p>
            </div>
            ...
            <div className="relative">
              ...
              <label
                ...
                className="flex flex-col items-center justify-center w-full p-8 bg-black/30 backdrop-blur-md border-2 border-dashed border-white/20 rounded-xl text-gray-400 hover:border-cyan-400/50 hover:text-cyan-400 transition-all duration-300 cursor-pointer group"
              >
                {formData.selfie ? (
                  <div className="text-center">
                    <div className="w-24 h-24 mx-auto mb-4 rounded-full overflow-hidden border-4 border-cyan-400/30">
                      <img 
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-black/90 backdrop-blur-xl border border-white/20 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-white/10">
          <div className="flex items-center gap-4">
            <h2 className="text-2xl font-bold text-white">Create Your ShadowTwin</h2>
            <div className="flex items-center gap-2 px-3 py-1 bg-violet-500/20 border border-violet-400/30 rounded-full">
        ...
        <div className="flex items-center justify-between p-6 border-t border-white/10">
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 border border-white/20 rounded-lg text-white hover:bg-white/5 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <ArrowLeft size={16} />
            Previous
          </button>
          ...
          <button
            onClick={handleNext}
            className="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-violet-500 to-cyan-500 rounded-lg text-white font-medium hover:scale-105 transition-all duration-300"
          >
